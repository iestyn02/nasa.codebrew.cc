    ...
    return (
        <header className="flex justify-between items-center py-4">
            <svg className="hidden" xmlns="http://www.w3.org/2000/svg">
                <symbol id="icon-logo" viewBox="0 0 508.204 141.732" preserveAspectRatio="xMidYMid meet">
          ...
          <div className="text-xl font-bold">
            {/* <span className="logo" style={{  backgroundImage: 'url(logo.svg)' }}></span> */}
            <svg width="52" height="50" viewBox="0 0 508.204 141.732" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon-logo" />
            </svg>
          </div>
